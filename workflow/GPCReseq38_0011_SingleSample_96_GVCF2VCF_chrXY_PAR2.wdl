...
workflow GPCReseq38_0011_SingleSample_96_GVCF2VCF_chrXY_PAR2 {
    ...
    call vcfconcat.vcfconcat as step0002_concat_vcfs { input:
        ...
        result_vcf_gz__name = "${sample_id_with_suffix}.chrXY_PAR2.vcf.gz",
        apply_sort = true,
    ...
    call md5sum.md5sum as step9999_md5sum { input:
        ...
        md5sum_txt__name = "${sample_id_with_suffix}.GPCReseq_0011_SingleSample_96_GVCF2VCF_chrXY_PAR2.md5sum.txt",
